    ...
    const books = {
        "books": [
            ...
            },
            {
                ...
                "imageLinks": {
                    "smallThumbnail": "http://books.google.com/books/content?id=ycTADgAAQBAJ&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api",
                    "thumbnail": "http://books.google.com/books/content?id=ycTADgAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api"
                },
                "language": "en",
                "previewLink": "http://books.google.com/books?id=ycTADgAAQBAJ&printsec=frontcover&dq=react&hl=&cd=3&source=gbs_api",
                "infoLink": "http://books.google.com/books?id=ycTADgAAQBAJ&dq=react&hl=&source=gbs_api",
                "canonicalVolumeLink": "https://books.google.com/books/about/Learning_React.html?hl=&id=ycTADgAAQBAJ",
                "id": "ycTADgAAQBAJ",
                "shelf": "wantToRead"
            },
            {
            ...
            },
            {
                ...
                "publishedDate": "2007",
                "description": "Provides a thorough discussion of robots and robotics technology.",
                "industryIdentifiers": [
                    {
                        "type": "ISBN_10",
                ...
                "imageLinks": {
                    "smallThumbnail": "http://books.google.com/books/content?id=73kNFV4sDx8C&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api",
                    "thumbnail": "http://books.google.com/books/content?id=73kNFV4sDx8C&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api"
                },
                "language": "en",
                "previewLink": "http://books.google.com/books?id=73kNFV4sDx8C&printsec=frontcover&dq=robotics&hl=&cd=3&source=gbs_api",
                "infoLink": "http://books.google.com/books?id=73kNFV4sDx8C&dq=robotics&hl=&source=gbs_api",
                "canonicalVolumeLink": "https://books.google.com/books/about/Robotics.html?hl=&id=73kNFV4sDx8C",
                "id": "73kNFV4sDx8C",
                "shelf": "read"
            }
        ]
    };
    test('renders list of books if book found when user search it', async () => {
        const searchedBooks = [
            {
                "title": "Learning Web Development with React and Bootstrap",
                "authors": [
        ...
        render(<GetBooks searchedBooks={searchedBooks} fetchedBooks={books.books} changeBookShelf={changeBookShelf}/>);

        const bookshelfElements = await screen.findAllByText(searchedBooks[0].title);
        expect(bookshelfElements).not.toHaveLength(0);
    });
    test('renders No books found if book not found when user search it', async () => {
        const searchedBooks = [];
        window.fetch = jest.fn();
        window.fetch.mockResolvedValueOnce({
            json: async () => books,
        ...
        const bookshelfElements = await screen.findAllByText('No books found');
        expect(bookshelfElements).not.toHaveLength(0);
    });
});
