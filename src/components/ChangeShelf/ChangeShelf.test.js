...
describe('Greeting component', () => {
    ...
    test('selects "currentlyReading" from dropdown options', async () => {
        const book = {
        ...
        render(<ChangeShelf book={book} onShelfChange={onShelfChange} />);

        const dropdown = await screen.getByRole('combobox');
        fireEvent.change(dropdown, { target: { value: 'currentlyReading' } });
        expect(dropdown).toBeInTheDocument();
        expect(dropdown.value).toEqual('currentlyReading');
    });

    test('selects "wantToRead" from dropdown options', async() => {
        const book = {
            "title": "Learning Web Development with React and Bootstrap",
            "authors": [
                "Harmeet Singh",
        ...
        const dropdown = await screen.getByRole('combobox');
        fireEvent.change(dropdown, { target: { value: 'wantToRead' } });
        expect(dropdown).toBeInTheDocument();
        expect(dropdown.value).toEqual('wantToRead');
    });

    test('selects "read" from dropdown options', async() => {
        const book = {
            "title": "Learning Web Development with React and Bootstrap",
            "authors": [
                "Harmeet Singh",
        ...
        fireEvent.change(dropdown, { target: { value: 'read' } });
        expect(dropdown).toBeInTheDocument();
        expect(dropdown.value).toEqual('read');
    });
